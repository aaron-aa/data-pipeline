...
from ingest.interfaces.common_schema import DATA_TYPE_ENUM
from utils.avro_ import create

DATA_NAME = {
    "name": "data_name",
    "type": "string",
    "default": "featured_story"
}
        ...
        "update": {
            "schema": create({
                ...
                "fields": [
                    ...
                    {
                        "name": "set",
                        "doc": "target fields would be updated",
                        "type": {
                            "type": "record",
                            "name": "update.set",
                            "fields": [{
                                ...
                                "type": {
                                    ...
                                    "items": {
                                        ...
                                        "name": "e_fields",
                                        "symbols": [
                                            "url", "rank", "svg", "raw_data", "creative_urls",
                                            "product_ids", "label", "head", "description",
                                            "content", "display_style", "country_code", "date"
                                        ]
                                    }
                                }
                            }]
                    ...
                    },
                    {
                        ...
                        "type": {
                            ...
                            "fields": [
                                ...
                                {"name": "raw_data", "type": ["null", "string"]},
                                {
                                    "name": "creative_urls",
...
INSERT_DUMMY_DATA = [
    ...
    },
    {
        ...
        "date": "2017-11-29",
        "featured_story_id": 7898971999,
        "url": u"https://itunes.apple.com/cn/story/id7898971999",
        "rank": 4,
        "product_ids": [138475211],
        "raw_data": "",
        "svg": "demo svg 1"
    },
    {
